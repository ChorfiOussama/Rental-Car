  ...
  <div class="container py-5">
    <div class="bg-banner py-5 px-4 text-center">
      <div class="py-5">
        ...
        <a class="btn btn-primary mt-2 py-3 px-5" href="<?php echo e(route('voiture.index')); ?>"> Nos Voitures </a>
      </div>
    </div>
  </div>
</div>
...
<?php echo $__env->make('voitures.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\PFE\resources\views/voitures/home.blade.php ENDPATH**/ ?>