            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mx-auto py-0">
                  <li>
                    <a href="{{ route('locataire.index') }}" class="nav-item nav-link active">
                      Locataire 
                    </a>
                  </li>

                  <li>
                    <a href="{{ route('voitures.index') }}" class="nav-item nav-link">
                      Les Voitures
                    </a>
                  </li>
                  <li>
                    <a href="{{ route('reserver.index') }}" class="nav-item nav-link">
                      Réservations
                    </a>
                  </li>
